...
To build the final jar and optimize the ciruelos application for production, run:
...
Then navigate to [http://localhost:6969](http://localhost:6969) in your browser.
